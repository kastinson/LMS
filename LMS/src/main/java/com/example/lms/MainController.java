...
public class MainController {
    ...
    /**
     * Initializes a new instance of the {@code MainController} class.
     *
     * This constructor ensures that a {@link BookService} instance is created
     * and ready to manage book-related operations. The {@link BookService} instance
     * is initialized when the {@code MainController} is constructed.
     *
     * @throws SQLException if a database access error occurs during the initialization
     *                      of the {@link BookService} instance
     */
