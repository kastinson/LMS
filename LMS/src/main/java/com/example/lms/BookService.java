...
public class BookService {
    ...
    /**
     * Initializes a new instance of the {@code BookService} class.
     *
     * This constructor creates an empty {@link ArrayList} to hold {@link Book} objects
     * and populates it by loading books from the database using the {@link BookDAO#loadBooksFromDatabase(List)} method.
     *
     * @throws SQLException if a database access error occurs while loading books
     */
     ...
     * @return boolean True is book was successfully removed
     */
     ...
     * @return boolean True is book was successfully checked out.
     */
     ...
     * @return boolean True is book was checked in
     */
